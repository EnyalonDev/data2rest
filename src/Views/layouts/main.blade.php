...
<body class="selection:bg-primary/30">
    ...
    <main class="container mx-auto pt-32 pb-20 px-6">
        ...
        <footer class="mt-24 pt-12 border-t border-glass-border flex flex-col items-center gap-6">
            @if(\App\Core\Auth::isAdmin() && \App\Core\Auth::isDevMode())
                <div
            ...
            <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <!-- Right Content (Last Commit) -->
                <div class="w-full md:w-72">
                    <div
                        class="bg-black/20 backdrop-blur-md border border-white/5 p-4 rounded-2xl hover:border-primary/20 transition-all group">
