                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-2">
                                    <a href="{{ $baseUrl }}admin/users?group_id={{ $group['id'] }}"
                            ...
                            <td class="px-8 py-6 text-right">
                                <div class="flex justify-end gap-3 opacity-60 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ $baseUrl }}admin/groups/edit?id={{ $group['id'] }}"
                                    ...
                                    <button onclick="confirmDelete({{ $group['id'] }}, '{{ addslashes($group['name']) }}')"
    ...
    <script>
        function confirmDelete(id, name) {
            showModal({
                ...
                onConfirm: () => {
                    window.location.href = `{{ $baseUrl }}admin/groups/delete?id=${id}`;
                }
            });
        }
    </script>
