    ...
    <div>
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-4xl font-black text-white italic tracking-tighter uppercase">
                <?php echo ucfirst($ctx['table']); ?> <span class="text-primary italic">Ledger</span></h1>
        </div>
        <p class="text-slate-500 font-medium tracking-tight">Accessing data stream for
            <b><?php echo htmlspecialchars($ctx['database']['name']); ?></b>.</p>
    </div>
                            ...
                            <td class="px-8 py-6 sticky-col group-hover:bg-dark transition-colors">
                                <div
                                    ...
                                    <a href="<?php echo $baseUrl; ?>admin/crud/edit?db_id=<?php echo $ctx['db_id']; ?>&table=<?php echo $ctx['table']; ?>&id=<?php echo $row['id']; ?>"
                                        ...
                                        title="Edit Record"><svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                    ...
                                    <button onclick="confirmKillNode(<?php echo $row['id']; ?>)"
                                        class="p-2 bg-white/5 rounded-lg text-slate-400 hover:text-red-500 hover:bg-red-500/10 transition-all"
                                        title="Kill Node"><svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
