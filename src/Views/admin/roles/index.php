...
<header class="mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
    <div>
        <h1 class="text-5xl font-black text-p-title italic tracking-tighter mb-2">
            <?php echo Lang::get('roles_list.title'); ?>
        </h1>
        <p class="text-p-muted font-medium"><?php echo Lang::get('roles_list.subtitle'); ?></p>
    </div>
                ...
                <tr class="hover:bg-white/[0.02] transition-colors group">
                    <td class="px-8 py-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-p-title"><?php echo htmlspecialchars($r['name']); ?></p>
                    ...
                    <td class="px-8 py-6 text-right">
                        <div class="flex justify-end gap-3 opacity-60 group-hover:opacity-100 transition-opacity">
                            <a href="<?php echo $baseUrl; ?>admin/roles/edit?id=<?php echo $r['id']; ?>"
                            ...
                            <button
                                onclick="confirmDeleteRole(<?php echo $r['id']; ?>, '<?php echo htmlspecialchars($r['name']); ?>')"
