                ...
                <div
                    ...
                    <div class="flex gap-2">
                        ...
                        @if (\App\Core\Auth::isAdmin())
                            ...
                            <a href="{{ $baseUrl }}admin/projects/delete?id={{ $project['id'] }}"
                                onclick="return confirm('CRITICAL WARNING:\n\n1. This will DELETE the project \'{{ $project['name'] }}\'.\n2. All associated databases will be DELETED.\n3. A backup will be created before deletion.\n\nAre you sure you want to proceed?')"
                                class="px-3 py-3 bg-red-500/10 border border-red-500/20 text-red-500 hover:bg-red-500 hover:text-white rounded-xl transition-all">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
